...
//            ResultSet rs = stmt.executeQuery(sql);
            ...
            if (true)
            {
                ...
                String basicAuth = "Bearer {QWiSqwAAs1/FyPo+Rt+jKoxjjK+LbkQ1pC1zsmCO9s5g2YO9EFUsSKO90ABQpc8h31iecVkjMsG3IZ2J9xCcS5pHL0ph8nc81PIM+gJEFzkJpHIRBWiJQl7sh6dOuuApuPMC+aj1HjkT5iaHCXDJ5AdB04t89/1O/w1cDnyilFU=}";
                GUI.jTextArea2.append("\"Bearer {QWiSqwAAs1/FyPo+********************}\";\n");
                GUI.thisgui.repaint(); GUI.thisgui.validate();
                conn.setRequestProperty("Authorization", basicAuth);

                String line = "C11819af005e87a162e1a41fb264ca330";
                GUI.jTextArea2.append("Line craete done");
                GUI.jTextArea2.append(line + "\n");
                GUI.thisgui.repaint(); GUI.thisgui.validate();
                String data = null;
                if (messagein.equals(""))
                {
                    messagein = "Announcement :";
                    tick++;
                }
                else
                    tick++;
                ...
                GUI.jTextArea2.append("Ann craete done");
                if (!(urlin.equals("")))
                {
                    tick++;
